-- roles
INSERT INTO role(id, name) VALUES (nextval('role_seq_gen'), 'ROLE_CLIENT');
INSERT INTO role(id, name) VALUES (nextval('role_seq_gen'), 'ROLE_ADMIN');
INSERT INTO role(id, name) VALUES (nextval('role_seq_gen'), 'ROLE_COTTAGE_OWNER');
INSERT INTO role(id, name) VALUES (nextval('role_seq_gen'), 'ROLE_SHIP_OWNER');
INSERT INTO role(id, name) VALUES (nextval('role_seq_gen'), 'ROLE_INSTRUCTOR');

-- address
INSERT INTO address (address_id, city, country, latitude, longitude, postal_code, street_name, street_number)
VALUES (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Bulevar Kralja Petra I', '11'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 44.1, 19.5, '21000', 'Bulevar oslobodjenja', '21'),
       (nextval('address_seq_gen'), 'Sabac', 'Srbija', 0.0, 0.0, '15000', 'Janka Veselinovica', '25'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Janka Cmelika', '5a'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Bulevar Despota Stefana', '10'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Safarikova', '1b'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Kralja Aleksandra', '12'),
       (nextval('address_seq_gen'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Petra Drapsina', '2'),
       (nextval('address_seq_gen'), 'Sabac', 'Srbija', 0.0, 0.0, '15000', 'dr Andre Jovanovica', '6'),
       (nextval('address_seq_gen'), 'Subotica', 'Srbija', 0.0, 0.0, '23000', 'Mihaila Pupina', '6');
...
VALUES ('ADMIN', nextval('user_seq_gen'), 'user.fishingbooker+admin1@gmail.com', true, 'Zdravko', 'Colic', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0645656565', 0, true, null, null, null, null, 1, 2),
       ('INSTRUCTOR', nextval('user_seq_gen'), 'user.fishingbooker+instr@gmail.com', true, 'Ana', 'Gavrilovic', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0648623758', 0, null, null, null, null, 'Zavrsila je Sabacku gimnaziju i FTN smer e2.', 3, 5),
       ('COTTAGE_OWNER', nextval('user_seq_gen'), 'user.fishingbooker+cottage@gmail.com', true, 'Marija', 'Kljestan', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0641234567', 0, null, null, null, null, null, 5, 3),
...
VALUES (nextval('system_property_seq_gen'), 'INCOME_PERCENTAGE', '15', 0),
       (nextval('system_property_seq_gen'), 'MAIN_ADMIN_ID', '1', 0);
...
VALUES (nextval('room_seq_gen'), 2), (nextval('room_seq_gen'), 3);
...
VALUES (nextval('pricelist_item_seq_gen'), 5000, 'Standard offer', 1),
       (nextval('pricelist_item_seq_gen'), 1000, 'Music', 1);
...
VALUES (2, 'Smoking');
INSERT INTO pricelist_item(pricelist_item_id, price, service, entity_id)
VALUES (nextval('pricelist_item_seq_gen'), 2000, 'Standard offer', 2);
...
VALUES (3, 'Smoking');
INSERT INTO pricelist_item(pricelist_item_id, price, service, entity_id)
VALUES (nextval('pricelist_item_seq_gen'), 2000, 'Standard offer', 3);
...
VALUES  (nextval('reservation_seq_gen'),'2022-01-05 00:00',72,false,7,4000,4,1),
        ...
        (nextval('reservation_seq_gen'),'2022-01-21', 72,false,5,7500,4,1),
...
VALUES (nextval('sale_seq_gen'),'2022-01-11 08:00:00',4,'2022-01-08 08:00:00',8,4000,2),
       (nextval('sale_seq_gen'),'2022-01-14 08:00:00',24,'2022-01-08 08:00:00',8,10000,1),
       (nextval('sale_seq_gen'),'2022-01-11 08:00:00',4,'2022-01-08 08:00:00',8,10000,3);

-- instructor - unavailable period
INSERT INTO unavailable_period(period_id,from_date_time,to_date_time)
VALUES (nextval('unavailable_period_seq_gen'),'2022-01-04 08:00:00','2022-01-04 12:30:00');
