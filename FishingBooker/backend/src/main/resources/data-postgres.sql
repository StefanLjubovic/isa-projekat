...
INSERT INTO address (address_id, city, country, latitude, longitude, postal_code, street_name, street_number)
VALUES (nextval('address_address_id_seq'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Janka Cmelika', '5a');
INSERT INTO address (address_id, city, country, latitude, longitude, postal_code, street_name, street_number)
VALUES (nextval('address_address_id_seq'), 'Novi Sad', 'Srbija', 0.0, 0.0, '21000', 'Bulevar Despota Stefana', '10');
INSERT INTO address (address_id, city, country, latitude, longitude, postal_code, street_name, street_number)
VALUES (nextval('address_address_id_seq'), 'Beograd', 'Srbija', 0.0, 0.0, '11000', 'Safarikova', '1b');
...
INSERT INTO registered_user(type, reg_user_id, email, enabled, first_name, last_name, last_password_reset_date, password, phone_number, user_status, initial_password_changed, cancellation_number, client_type, points, short_biography, address_id, role_id)
VALUES ('INSTRUCTOR', nextval('user_seq_gen'), 'ana.gavrilovic247@gmail.com', true, 'Ana', 'Gavrilovic', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0648623758', 0, null, null, null, null, 'Zavrsila je Sabacku gimnaziju i FTN smer e2.', 3, 5);
INSERT INTO registered_user(type, reg_user_id, email, enabled, first_name, last_name, last_password_reset_date, password, phone_number, user_status, initial_password_changed, cancellation_number, client_type, points, short_biography, address_id, role_id)
VALUES ('COTTAGE_OWNER', nextval('user_seq_gen'), 'marijakljestan@gmail.com', true, 'Marija', 'Kljestan', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0641234567', 0, null, null, null, null, null, 5, 3);
INSERT INTO registered_user(type, reg_user_id, email, enabled, first_name, last_name, last_password_reset_date, password, phone_number, user_status, initial_password_changed, cancellation_number, client_type, points, short_biography, address_id, role_id)
VALUES ('CLIENT', nextval('user_seq_gen'), 'ljubovicstefan@gmail.com', true, 'Stefan', 'Ljubovic', '2021-03-24 16:48:05.591', '$2a$10$3kfQZW0qQFJIlfDcadR9UOmPwUDDz4wwkcxxAi1aQmfqZqRxAU/FW', '0648855959', 0, null, 0, 0, 0, null, 4, 1);
...
VALUES (nextval('room_room_id_seq'), 2, 1);
INSERT INTO room(room_id, bed_number, entity_id)
VALUES (nextval('room_room_id_seq'), 3, 1);
INSERT INTO renting_entity_allowed_behavior(entity_id, allowed_behaviour)
VALUES (1, 'Bringing pets');
INSERT INTO renting_entity_allowed_behavior(entity_id, allowed_behaviour)
VALUES (1, 'Music');
...
VALUES (2, 'Fishing rod');
INSERT INTO adventure_fishing_equipment(entity_id, fishing_equipment)
VALUES (2, 'Hooks');
INSERT INTO adventure_fishing_equipment(entity_id, fishing_equipment)
VALUES (2, 'Food');
INSERT INTO renting_entity_allowed_behavior(entity_id, allowed_behaviour)
VALUES (2, 'Bringing pets to the adventure.');
INSERT INTO renting_entity_allowed_behavior(entity_id, allowed_behaviour)
VALUES (2, 'Alcohol is allowed!');
INSERT INTO renting_entity_unallowed_behavior(entity_id, unallowed_behaviour)
VALUES (2, 'Smoking');
INSERT INTO pricelist_item(pricelist_item_id, price, service, entity_id)
